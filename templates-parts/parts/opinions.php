                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="opinions-wraper__item">
                            <div class="top">
                                <div class="stars">
                                    <img class="header-bg" src="<?php echo get_template_directory_uri() ?>/src/img/stars-<?php echo $opinia['ilosc_gwiazdek']; ?>.png" alt="opinie">
                                </div>
                                <div class="social">
                                    <?php echo wp_get_attachment_image(  $opinia['portal'], 'icon' ); ?>
                                </div>
                            </div>
                            <div class="content">
                                <p><?php echo $opinia['opinia']; ?></p>
                                <p class="h3"><b> <?php echo $opinia['imie_']; ?></b></p>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
