...
$url      = get_field('link', 'options');
?>
<section id="banner-hor">
    <div class="banner-hor__wraper">
        <div class="banner-hor__wraper__content">  
            <p class="h4">  Zapraszamy na wizytę.</p>
            <p>Umów się na wizyte i skorzystaj z naszego doświadczenia</p>
        </div> 
        <div class="banner-hor__wraper__url">  
            <a href="#" class="btn">Umów się na wizytę
